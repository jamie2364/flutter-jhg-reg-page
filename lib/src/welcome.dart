...
class _WelcomeState extends State<Welcome> {
  ...
  initStore(BuildContext context) async{
    ...
    if(productDetailsResponse.error == null){
      ...
      showToast(context: context, message: productDetailsResponse.error!.message, isError: true);
  ...
  listenToPurchase(List<PurchaseDetails> purchaseDetailsList) {
    purchaseDetailsList.forEach((PurchaseDetails purchaseDetails) async {
      if (purchaseDetails.status == PurchaseStatus.pending) {
        showToast(context: context, message: purchaseDetails.error!.message, isError: true);
        debugPrint("pending");
        ...
        showToast(context: context, message: purchaseDetails.error!.message, isError: false);
        Navigator.pop(context);
      }
  ...
  Future<void> purchaseSubscription(int plan)async{
    ...
    final PurchaseParam param = PurchaseParam(productDetails: plan == 1 ? products [0] :  products [1]);
    try {
    ...
    return  Scaffold(
      ...
      body: Padding(
        ...
        child:
            ...
            loading ? Center(child: CircularProgressIndicator(color: AppColor.primaryRed,),) :
        Column(
          ...
          children: [
                    ...
                    child:  Container(
                      ...
                      decoration: BoxDecoration(
                          gradient: LinearGradient(
                              ...
                              colors: [Colors.transparent, Colors.transparent,AppColor.primaryBlack]
                          )
                      ),
                    )),
                Positioned(
            ...
            Padding(
              ...
              child: Column(
                ...
                CustomButton(buttonName: selectedPlan == 1 ? Constant.tryFree :  Constant.continueText ,
