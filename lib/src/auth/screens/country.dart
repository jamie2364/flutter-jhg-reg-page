...
class Contact {
  ...
  static void loadCountriesFromJson() {
    _countries = jsonList.map((json) => Country.fromJson(json)).toList();
  }

  // Static method to get country flag emoji by country name
  static String getCountryFlagEmoji(String countryName) {
    loadCountriesFromJson();
    String? countryCode = _countries
        .firstWhere((country) => country.name == countryName,
            orElse: () => Country(name: null, dialCode: null, code: null))
        .code;
